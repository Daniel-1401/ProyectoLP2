...
<head>
    ...
    <link rel="stylesheet" href="css/cssPagAdmin/crudA�adir.css">
</head>
<body>
	<main>
		<div class="content">
			...
			<div class="contenidoPrincipal">
				<section style="width: 65%;float: left;">
                    <h2>A�adir nuevo producto de cuenta</h2>
                    <form action="prodServ" method="post" enctype="multipart/form-data">
                        ...
                        <br>
                        <button type="submit" class="btn btn-primary" name="opcion" value="a�adirProducto">A�adir</button>
                    </form>
                </section>
			</div>
		</div>
